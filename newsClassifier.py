...
print ("LogisticRegression accuracy score : ",accuracy_score(label_pred,label_test))
...
print ("Naive Bayes accuracy score : ",accuracy_score(label_pred_nb,label_test))
...
print ("RandomForestClassifier accuracy score : ",accuracy_score(label_pred_rf,label_test))
...
print ("SVM accuracy score : ",accuracy_score(label_pred_svm,label_test))
